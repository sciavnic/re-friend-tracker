<a (click)="button.onClick()" class="fa-links">
	<div tooltip="{{button.tooltip}}" *ngIf="button.visible" class="thumbnail tile {{(button.width > 1 ? 'tile-wide' : '')}} tile-medium tile-{{button.color}} col-md-3">
