...
var FriendRestService = (function (_super) {
    __extends(FriendRestService, _super);
    function FriendRestService(app, database) {
        var _this = _super.call(this, app, database) || this;
        _this.database = database;
        return _this;
    }
    FriendRestService.prototype.initList = function () {
        var _this = this;
        _super.prototype.initList.call(this);
        var service = this;
        this._app.get('/services/activity/:activityKey/friend', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var friends, activityKey, activity, result, _i, friends_1, friend, _a, _b, friendKey;
    ...
    return FriendRestService;
}(abstract_rest_service_1.AbstractRestService));
exports.FriendRestService = FriendRestService;
//# sourceMappingURL=friend-rest-service.js.map